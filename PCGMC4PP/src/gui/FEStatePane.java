...
public class FEStatePane extends JPanel {
    ...
    JFormattedTextField pcgRandomSeed = null;
    ...
    public FEStatePane() {
            ...
            ptmp.setLayout(new BoxLayout(ptmp, BoxLayout.X_AXIS));
            {
                ...
                b.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                            try {
                                long randomSeed = Long.parseLong(pcgRandomSeed.getText());
                                pcgRandomSeed.setText(Long.toString(randomSeed+1));
        ...
        pcgRandomSeed = addTextField(panelLeft, "Random Seed:", "0", 5);
